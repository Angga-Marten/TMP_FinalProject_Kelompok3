...
(function () {
  function init() {
    ...
    const registeredTeams = [
      { teamName: "TechInnovators", password: "Pass123!" },
      { teamName: "CodeMasters", password: "Secure456@" },
      { teamName: "HackathonPro", password: "Hack789#" },
    ];
    ...
    function setupFormSubmission() {
      ...
      loginForm.addEventListener("submit", function (e) {
        ...
        setTimeout(() => {
          ...
          if (team) {
            localStorage.setItem("hackathonLoggedIn", "true");
            localStorage.setItem("hackathonTeamName", teamName);
            ...
            showToast(
              "Invalid team name or password. Please try again.",
              "error"
            );
          }
        }, 1500);
