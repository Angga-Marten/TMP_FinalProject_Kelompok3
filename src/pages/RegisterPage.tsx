      ...
      <header>
        <div className="container">
          <nav>
            ...
            <a href="\landingpage" className="btn" style={{"padding": "12px 28px"}}>
          ...
          <div className="register-box glass">
            ...
            <form id="step2" className="form-step">
              ...
              <div className="form-navigation">
                ...
                <button type="button" className="btn btn-next" onClick={() => window.prevStep(2)}>Next <i className="fas fa-arrow-right"></i></button>
              </div>
            </form>
