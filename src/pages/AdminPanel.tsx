        ...
        <div>
            ...
            <div id="loginPage" className="login-container">
                <div className="login-box glass">
                    ...
                    <form id="loginForm" className="login-form">
                        ...
                        <button type="submit" className="login-btn">Login <i className="fas fa-sign-in-alt"></i></button>
                    </form>

                    <div style={{ textAlign: 'center', marginTop: '30px', color: 'var(--text-light)', fontSize: '0.9rem' }}>
                        <p>Default credentials: Group: <strong>admin</strong> | Password: <strong>admin123</strong></p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="admin-box glass">
                            ...
                            <div className="dashboard-stats">
                                <div className="stat-card">
                                    ...
                                    <div className="stat-number" id="totalTeams">0</div>
                                ...
                                <div className="stat-card">
                                    ...
                                    <div className="stat-number" id="binusianTeams">0</div>
                            ...
                            <div id="emptyState" style={{ textAlign: 'center', padding: '60px 20px', display: 'none' }}>
                                <i className="fas fa-users" style={{ fontSize: '4rem', color: 'var(--text-light)', marginBottom: '20px' }}></i>
                                <h3 style={{ color: 'var(--text-light)', marginBottom: '10px' }}>No Teams Found</h3>
                                <p style={{ color: 'var(--text-light)' }}>No teams have registered yet or match your search criteria.</p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div className="modal-overlay" id="viewModal">
                <div className="modal">
                    ...
                    <div className="modal-body">
                        <div className="team-details" id="teamDetailsContent">
                        </div>

                        <div className="participants-list" id="participantsList">
                        </div>
                    </div>
                    <div className="modal-footer">
                        <button className="btn btn-cancel" id="closeViewModalBtn">Close</button>
                    </div>
                </div>
            </div>
            ...
            <div className="modal-overlay" id="editModal">
                <div className="modal">
                    ...
                    <div className="modal-body">
                        <form id="editTeamForm" className="edit-form">
                        </form>
                    </div>
                    <div className="modal-footer">
                        <button className="btn btn-cancel" id="cancelEditBtn">Cancel</button>
                        <button className="btn btn-save" id="saveEditBtn">Save Changes</button>
                    </div>
                </div>
            </div>
            ...
            <div className="modal-overlay" id="deleteModal">
                <div className="modal" style={{ maxWidth: '400px' }}>
                    ...
                    <div className="modal-body">
                        <p style={{ textAlign: 'center', color: 'var(--text-light)', fontSize: '1.1rem', marginBottom: '15px' }}>
                            <i className="fas fa-exclamation-triangle" style={{ color: 'var(--warning)', fontSize: '3rem', marginBottom: '20px', display: 'block' }}></i>
                            Are you sure you want to delete <strong id="deleteTeamName">[Team Name]</strong>?
                        </p>
                    ...
                    <div className="modal-footer">
                        <button className="btn btn-cancel" id="cancelDeleteBtn">Cancel</button>
                        <button className="btn btn-delete" id="confirmDeleteBtn">Delete Team</button>
                    </div>
                </div>
            </div>
        </div>
